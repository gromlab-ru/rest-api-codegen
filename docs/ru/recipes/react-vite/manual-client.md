...
Когда появится актуальная OpenAPI, замените ручные операции сгенерированными. Настройки `HttpClient`, структура клиентов и вызовы в приложении могут остаться прежними. Подробная миграция описана в [руководстве ручного сценария](../../06_manual-client.md).
